    ...
    const projectData = {
        'earthquake': {
            ...
            content: `
                ...
                <h3>Project Links</h3>
                <a href="#" target="_blank" rel="noopener noreferrer">View Publication (IEEE Xplore pending) &rarr;</a><br>
                <a href="http://idap.inonu.edu.tr/frontend/pages/accepted-papers.xhtml" target="_blank" rel="noopener noreferrer">IDAP Accepted Papers &rarr;</a>
            `
        },
        'sentiment': {
